const Footer = () => {
  return (
    <div>
      <hr className='w-full' />
      <div className='py-8 ps-56 pe-44 text-center'>
        <p className='text-[#a1a1a1] text-sm font-medium'>
          ...
          damage which may arise from reliance on the information contained on this website.
        </p>
        <p className='mt-5 text-sm font-medium text-[#767676]'>Copyright 2021 HLS</p>
      </div>
    </div>
  );
};
